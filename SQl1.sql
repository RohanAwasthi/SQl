...
select *
from customers
where birth_date <= 1986/01/01 AND birth_date >= 1986/12/12;

select *
from customers 
where birth_date >= 1986/01/01 AND points >2000;


select * 
from customers
where state not in('MA','CO','TX');
...
select *
from customers 
where last_name REGEXP 'rose|mac';
